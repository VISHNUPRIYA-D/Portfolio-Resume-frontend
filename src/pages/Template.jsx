...
const Template = () => {
  const { id } = useParams();
  const { templates, finalUser, def, handleDownloadPdf, printRef, navigate, saveDownload,setSaveDownload } =
  ...
  return (
    <div className="min-h-screen dark:bg-gray-800 bg-gray-100 dark:text-white px-4 sm:px-6 py-6 flex flex-col">
      ...
      <div
        ref={printRef}
        className="bg-white rounded-xl shadow-md max-w-5xl mx-auto  sm:p-6 lg:p-10 overflow-x-auto"
      >
